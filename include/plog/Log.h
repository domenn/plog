...
#if defined(_MSC_VER) && _MSC_VER >= 1600 && !defined(__INTELLISENSE__) && !defined(__INTEL_COMPILER) && !defined(__llvm__) && !defined(VS_NO_USE_IF_EXISTS) // >= Visual Studio 2010, skip IntelliSense, Intel Compiler and Clang Code Model
